...
function navigation(pathname, hasLoggedIn) {
	...
	return (
		<nav>
			<ol>
				<li>
					<a className="homeJs" href="/" style={pathname.startsWith('/') ? 'font-weight:bold' : ''}>Makpal</a>
				</li>
				<li>
					<a className="secondHomeJs" href="/secondHome" style={pathname.startsWith('/secondHome') ? 'font-weight:bold' : ''}>Makpal2</a>
				</li>
				<li>
					{sessionState}
				</li>
